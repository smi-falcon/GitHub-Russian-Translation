...
(function() {
    ...
    const translations = {
        ...
        'Add deployment branch or tag rule': 'Добавить правило для ветки или тега развертывания',
        'Add environment secret': 'Добавить секрет среды',
        'Add environment variable': 'Добавить переменную среды',
        ...
        'Allow administrators to bypass configured protection rules': 'Разрешить администраторам обходить настроенные правила защиты',
        ...
        'Configure reviewers, timers, and custom rules that must pass before deployments to this environment can proceed.': 'Настройте рецензентов, таймеры и пользовательские правила, которые должны быть выполнены, прежде чем развертывание в этой среде сможет продолжиться.',
        ...
        'create your own protection rules': 'создайте свои собственные правила защиты',
        ...
        'Deployment branches and tags': 'Ветки и теги развертывания',
        'Deployment limited to branches with protection rules.': 'Развертывание ограничено ветками, для которых установлены правила защиты.',
        ...
        'Enable custom rules with GitHub Apps': 'Включение настраиваемых правил с помощью приложений GitHub',
        ...
        'Environment changes successfully saved: all branches can deploy.': 'Изменения в среде успешно сохранены: все ветки готовы к развертыванию.',
        ...
        'Learn about existing apps': 'Узнайте о существующих приложениях',
        ...
        'Learn more about syncing a fork': 'Узнайте больше о синхронизации форка',
        ...
        'Limit which branches and tags can deploy to this environment based on rules or naming patterns.': 'Ограничьте список веток и тегов, которые можно развертывать в этой среде, на основе правил или шаблонов именования.',
        ...
        'No branch or tag rules applied yet: all branches and tags are still allowed to deploy.': 'Пока не применены никакие правила для веток и тегов: развертывание по всем веткам и тегам по-прежнему разрешено.',
        ...
        'No restriction to which branch or tag from this repository can deploy.': 'Нет ограничений на то, в какую ветку или тег из этого репозитория можно выполнять развертывание.',
        ...
        'Protected branches only': 'Только защищенные ветви',
        ...
        'Required reviewers': 'Необходимые рецензенты',
        ...
        'Save protection rules': 'Сохранить правила защиты',
        'Search Gists': 'Поиск Gists',
        'Search in this owner': 'Поиск по этому владельцу',
        'Search in this repository': 'Поиск в этом репозитории',
        'Search this repository': 'Поиск в этом репозитории',
        'Secret': 'Секрет',
        'secret context': 'скрытый контекст',
        ...
        'Secrets are encrypted environment variables. They are accessible only by GitHub Actions in the context of this environment by using the': 'Секреты — это зашифрованные переменные среды. Доступ к ним имеют только GitHub Actions в контексте данной среды с помощью',
        ...
        'Selected branches and tags': 'Выбранные ветви и теги',
        ...
        'Set an amount of time to wait before allowing deployments to proceed.': 'Укажите время ожидания, по истечении которого будет разрешено продолжить развертывание.',
        ...
        'so you can deploy with confidence.': 'чтобы вы могли с уверенностью осуществлять развертывание.',
        'Social preview': 'Социальный просмотр',
        'Soft wrap' : 'Мягкий перенос',
        'Source': 'Источник',
        'Spaces': 'Пробелы',
        'Spam': 'Спам',
        'Specify a list of branches and tags using naming patterns.': 'Укажите список веток и тегов, используя шаблоны именования.',
        'Specify people or teams that май approve workflow runs when they access this environment.': 'Укажите сотрудников или команды, которые могут утверждать запуски рабочих процессов при входе в эту среду.',
        'Split': 'Разделение',
        ...
        'This branch is out-of-date': 'Эта ветвь устарела',
        ...
        'This branch has conflicts that must be resolved': 'В этой ветке имеются конфликты, которые необходимо устранить',
        ...
        'to make this branch match the upstream repository.': 'чтобы привести эту ветку в соответствие с репозиторием upstream.',
        ...
        'Update branch to merge the latest changes from the upstream repository into this branch.': 'Обновите ветку, чтобы включить в неё последние изменения из исходного репозитория.',
        ...
        'Value': 'Значение',
        'variable context': 'изменяющийся контекст',
        'Variables are used for non-sensitive configuration data. They are accessible only by GitHub Actions in the context of this environment by using the': 'Переменные используются для хранения неконфиденциальных данных конфигурации. Доступ к ним имеют только GitHub Actions в контексте данной среды с помощью',
        ...
        'will be removed from this branch.': 'будет удалено из этой ветки.',
        ...
        'You can resolve merge conflicts using the command line and a text editor.': 'Конфликты слияния можно устранять с помощью командной строки и текстового редактора.',
    ...
    function translateNumberedText(text) {
        ...
        // Проверяем паттерн "Discard X commits"
        const discardMatch = cleanText.match(/^Discard\s+(\d+)\s+commits?$/i);
        if (discardMatch) {
            const num = parseInt(discardMatch[1], 10);
            const commitWord = (num === 1) ? 'коммит' : ((num >= 2 && num <= 4) ? 'коммита' : 'коммитов');
            return `Отменить ${num} ${commitWord}`;
        }
